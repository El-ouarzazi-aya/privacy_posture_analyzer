...
if __name__ == "__main__":
    ...
    # OWASP issues detected:
    #   M6 (Privacy Controls)  — RECORD_AUDIO, READ_CONTACTS, READ_CALL_LOG
    #   M9 (Data Storage)      — READ_CONTACTS, READ_CALL_LOG
    #   M2 (Supply Chain)      — Google Ads, Facebook SDK, AppsFlyer
    #   M5 (Communication)     — INTERNET
    sample_classifications = [
        {"permission": "ACCESS_FINE_LOCATION", "classification": "NECESSARY", "risk_level": "MEDIUM",   "gdpr_concern": True},
        ...
        {"permission": "CAMERA",               "classification": "OPTIONAL",  "risk_level": "MEDIUM",    "gdpr_concern": True},
        {"permission": "READ_EXTERNAL_STORAGE","classification": "OPTIONAL",  "risk_level": "MEDIUM",    "gdpr_concern": False},
        {"permission": "INTERNET",             "classification": "NECESSARY", "risk_level": "LOW",       "gdpr_concern": False},
        {"permission": "POST_NOTIFICATIONS",   "classification": "NECESSARY", "risk_level": "LOW",       "gdpr_concern": False},
        {"permission": "BLUETOOTH_SCAN",       "classification": "OPTIONAL",  "risk_level": "MEDIUM",    "gdpr_concern": False},
        {"permission": "READ_PHONE_STATE",     "classification": "EXCESSIVE", "risk_level": "HIGH",      "gdpr_concern": True},
    ]

    sample_trackers = ["Google Ads", "Facebook SDK", "AppsFlyer", "Crashlytics"]

    print("Calculating privacy score — FitTracker Pro (health app)\n")
    result = calculate_score(sample_classifications, sample_trackers, "health")
    print_score_report(result)
    print("\nOWASP Mobile Top 10 categories triggered: M2, M5, M6, M9")